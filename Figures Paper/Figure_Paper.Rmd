...
library(readr)
####VI
BayesFactorVSModularityVI <- read_csv("BayesFactorVSModularityVI.csv")
head(BayesFactorVSModularity)
x<-seq(0,0.8,0.025)
df<-data.frame(BayesFactorVSModularityVI$BF,x)
ggplot(data=df, aes(x=x, y=BayesFactorVSModularityVI$BF, group=1)) +
