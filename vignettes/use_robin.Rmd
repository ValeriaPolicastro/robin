...
```{r}
proc <- robinProc(graph=graph, graphRandom=graphRandom, measure="vi", 
...
*MeanRandom* contained inside the *robinProc* output list.
...
the **comparison** output list.

```{r}
plotRobinCompare(graph=graph, model1=comp$Mean1, model2=comp$Mean2,
