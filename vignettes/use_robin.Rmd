...
*MeanRandom* contained inside the **robinRobust** output list or the *Mean1* and the 
*Mean2* contained inside the **robinCompare** output list.

```{r}
plotRobin(graph=graph, model1=proc$MeanReal, model2=proc$MeanRandom, legend=c("real data", "null model"), measure="vi")
```
...
```{r}
plotRobin(graph=graph, model1=comp$Mean1, model2=comp$Mean2, measure="vi", legend=c("fastGreedy", "louvain"), title="FastGreedy vs Louvain")
```
